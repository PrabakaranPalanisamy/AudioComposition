...
public class FFmpegQueryExtension {
    ...
    */
    ...
    fun mergeAudioVideo2(inputVideo: String, inputAudio: String, output: String,offset:String,duration:String,videoOffset:String,videoDuration:String): Array<String> {
        val inputs: ArrayList<String> = ArrayList()
        inputs.apply {
            add("-itsoffset")
            add(videoOffset)
...
//            add("-shortest")
    ...
    fun mergeAudioVideo3(inputVideo: String, inputAudio: String, output: String,offset:String,duration:String,videoOffset:String,videoDuration:String,volume:String): Array<String> {
        val inputs: ArrayList<String> = ArrayList()
        inputs.apply {
            add("-ss")
            add(videoOffset)
            ...
            add(inputAudio)
            add("-filter_complex")
            add("[1:a]volume=$volume,apad[A];[0:a][A]amerge[out]")
            add("-c:v")
            add("copy")
            add("-map")
            add("0:v")
